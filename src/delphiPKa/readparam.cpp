    ...
    while(getline(param, line))
    {
        ...
        if(!line.empty()) {
            ...
            if(pos != string::npos) {
                ...
                if(strtmp1 ==
                   "Convergence threshold (MAXC)")                   maxc  = stof(strtmp2);
                if(strtmp1 ==
                   "Cluster Delimitation Threshold (A)" ) clusterThreshold = stof(strtmp2);
                if(strtmp1 ==
                   "Variance of Gaussian distribution" )           fSigma  = stof(strtmp2);
