...
#endif
                cout << endl;
                cout << "Warning!! PDB contains multiple MODELS, the first one will be used, the rest will be skipped. " << endl;
                cout << endl;
#ifdef MPI_PARALLEL
            }
#endif
        ...
        if(line.substr(0,4)=="ATOM") {
            ...
            if (secMod1!="B" && secMod2!="B") {
                ...
                if (pdb_temp.atom_name != "OXT") {
                    ...
                    if(line.substr(12,1) != "H" && line.substr(13,1) != "H" && line.substr(14,1) != "H" && line.substr(15,1) != "H") {
